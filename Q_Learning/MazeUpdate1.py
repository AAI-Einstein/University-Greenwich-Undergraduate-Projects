...
def main():
  ...
  F = np.zeros(shape=[20,20], dtype=int)  # Feasible
  F[0,1] = 1; F[0,2] = 1; F[0,5] = 1; F[0,10] = 1; F[0,15] = 1 # 0 To x
  F[1,0] = 1; F[2,0] = 1; F[5,0] = 1; F[10,0] = 1; F[15,0] = 1 # x To 0
  F[5,10] = 1; F[10,11] = 1; F[10,15] = 1; F[15,10] = 1

  R = np.zeros(shape=[20,20], dtype=int)  # Rewards
...
# =============================================================
  ...
  Q = np.zeros(shape=[20,20], dtype=np.float32)  # Quality
